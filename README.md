...
- Improving [healthcheck](https://github.com/Dafenxz0/healthcheck), a CLI for checking repository quality, contribution activity, releases, and project readiness.
...
- Released a Windows installer flow for `healthcheck`.
- Added report filtering and richer project summaries.
